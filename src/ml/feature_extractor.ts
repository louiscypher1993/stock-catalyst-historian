...
function getPrimaryCategory(f: Json, snap: Json | null, row: EventFeatureRow): string {
...
function getSector(f: Json, snap: Json | null, row: EventFeatureRow): string {
...
function getConfidenceTier(f: Json, snap: Json | null, row: EventFeatureRow): { high: number; medium: number; low: number } {
